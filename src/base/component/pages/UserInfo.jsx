...
function UserInfo() {
  ...
  return (Object.keys(user).length===0&&loadingProfile===false)? null : loadingProfile?(<div className="container">
          ...
          <Link className="btn btn-outline btn-info my-5 text-lg text-slate-200  " onClick={clearUserInfo} to="/">Back To Search</Link>
           <div className="grid grid-cols-1  md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 gap-5 text-slate-200">
            <div className="card  image-full 	 shadow-lg ">
